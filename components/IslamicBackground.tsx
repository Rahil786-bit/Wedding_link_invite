...
export function IslamicBackground() {
  return (
    <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden" aria-hidden>
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_rgba(242,138,168,0.14),_transparent_42%),radial-gradient(ellipse_at_bottom,_rgba(52,15,24,0.9),_#13070c_70%)]" />
      ...
      <div className="absolute top-[30%] left-[-100px] h-[280px] w-[280px] rounded-full bg-accent-dim/40 blur-3xl" />
